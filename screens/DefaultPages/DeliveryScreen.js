  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Image style={styles.avatar} source={require('../../assets/Gas2.png')}/>
        </View>
        <View style={styles.SectionStyle}>

<Image source={require('../../assets/address.png')} style={styles.ImageStyle} />

  <TextInput
      style={{flex:1}}
      placeholder="Enter Your Address Here"
      underlineColorAndroid="transparent"
      onChangeText={val => this.addressChange(val)}
  />
